...
class SearchVC: UIViewController {
    ...
    let callToActionButton = GFButton(backgroundColor: .green, title: "Git Followers")
    ...
    @objc func pushFollowerListVC() {
        guard isUsernameEntered else {
            presentGFAlertOnMainThread(title: "Enter Name", message: "Please enter username whose you are looking for", buttonTitle: "Ok")
            return
        }
